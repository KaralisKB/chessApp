...
class Rook(override val color: PieceColor, startPosition: Position) : ChessPiece {
    ...
    override fun getImage(): Int {
        if (color == PieceColor.WHITE) return R.drawable.chess_rlt60 else return R.drawable.chess_rdt60
    }
